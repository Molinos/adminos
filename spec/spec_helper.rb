...
require 'adminos'
require 'support/ammeter'

require 'generators/adminos/i18n_generator'
...
require 'generators/adminos/feedback_generator'

require 'adminos/helpers/models/flag_attrs'
require 'adminos/helpers/models/array_attrs'
# require 'adminos/helpers/models/dom_id'

SimpleCov.start

ActiveRecord::Base.establish_connection adapter: :sqlite3, database: 'dummy_test'

Dir["#{File.dirname __dir__}/spec/support/**/*.rb"].each { |f| require f }
...
RSpec.configure do |config|
  ...
  config.include Database, type: :model
